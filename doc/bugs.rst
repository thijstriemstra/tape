...
***********************
Reporting Bugs in Tape
***********************

Bug reports should be submitted via the Tape Bug Tracker
(http://tape.collab.eu).  The bug tracker offers a Web form which allows
...
the Tape Bug Tracker.  If you don't already have a tracker account, select the
